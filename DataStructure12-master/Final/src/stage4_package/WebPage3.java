...
public class WebPage3
{
	public String url;
	public String name;
	public WordCounter3 counter;
	public double score;
	public ArrayList<Integer> keywordTimes = new ArrayList<Integer>();

	public WebPage3(String url, String name)
	{
		this.url = url;
		this.name = name;
		this.counter = new WordCounter3(url);
	}

	public void setScore(ArrayList<Keyword3> keywords) throws IOException
	{
		score = 0;
		// YOUR TURN
